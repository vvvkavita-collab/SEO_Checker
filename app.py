...
def seo_analysis_struct(data):
    ...
    pairs = [
        ("Title Length Ideal", "50–60 chars — readable headline, fits snippet, improves CTR", "Title Length Actual", len(title)),
        ("Meta Length Ideal", "150–160 chars — Google snippet length, ensures full message visible", "Meta Length Actual", len(meta)),
        ...
        ("Paragraph Count Ideal", "8+ — easy to read, scannable", "Paragraph Count Actual", paragraph_count),
        ...
        ("External Links Ideal", "2–4 — credibility, references trusted sources", "External Links Actual", external_links),
